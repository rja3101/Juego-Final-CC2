...
MapManager::MapManager() :
	coin_animation(CELL_SIZE, "C:\\Visual studio\\CCII\\JUEGO-CC2\\Images\\Coin.png", COIN_ANIMATION_SPEED),
	question_block_animation(CELL_SIZE, "C:\\Visual studio\\CCII\\JUEGO-CC2\\Images\\QuestionBlock.png", QUESTION_BLOCK_ANIMATION_SPEED)
{
	map_texture.loadFromFile("C:\\Visual studio\\CCII\\JUEGO-CC2\\Images\\Map.png");
...
{
	map_sketch.loadFromFile("C:\\Visual studio\\CCII\\JUEGO-CC2\\Images\\LevelSketch" + std::to_string(static_cast<unsigned short>(i_current_level)) + ".png");
}

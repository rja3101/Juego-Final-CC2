...
Goomba::Goomba(const bool i_underground, const float i_x, const float i_y) :
	...
	walk_animation(CELL_SIZE, "C:\\Visual studio\\CCII\\JUEGO-CC2\\Images\\GoombaWalk.png", GOOMBA_WALK_ANIMATION_SPEED)
{
	horizontal_speed = -GOOMBA_SPEED;

	if (0 == underground)
	{
		texture.loadFromFile("C:\\Visual studio\\CCII\\JUEGO-CC2\\Images\\GoombaDeath0.png");
	}
	else
	{
		texture.loadFromFile("C:\\Visual studio\\CCII\\JUEGO-CC2\\Images\\UndergroundGoombaDeath0.png");

		walk_animation.set_texture_location("C:\\Visual studio\\CCII\\JUEGO-CC2\\Images\\UndergroundGoombaWalk.png");
	}
}
...
void Goomba::die(const unsigned char i_death_type)
{
	...
	case 2:
	{
		if (GOOMBA_DEATH_DURATION == death_timer)
		{
			...
			if (0 == underground)
			{
				texture.loadFromFile("C:\\Visual studio\\CCII\\JUEGO-CC2\\Images\\GoombaDeath1.png");
			}
			else
			{
				texture.loadFromFile("C:\\Visual studio\\CCII\\JUEGO-CC2\\Images\\UndergroundGoombaDeath1.png");
			}
		}
	}
	}

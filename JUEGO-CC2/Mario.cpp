...
Mario::Mario() :
	...
	growth_timer(0),
	invincible_timer(0),
	big_walk_animation(CELL_SIZE, "C:\\Visual studio\\CCII\\JUEGO-CC2\\Images\\BigMarioWalk.png", MARIO_WALK_ANIMATION_SPEED),
	walk_animation(CELL_SIZE, "C:\\Visual studio\\CCII\\JUEGO-CC2\\Images\\MarioWalk.png", MARIO_WALK_ANIMATION_SPEED)
{
	texture.loadFromFile("C:\\Visual studio\\CCII\\JUEGO-CC2\\Images\\MarioIdle.png");
...
void Mario::die(const bool i_instant_death)
{
	...
	if (1 == i_instant_death)
	{
		...
		if (0 == powerup_state)
		{
			texture.loadFromFile("C:\\Visual studio\\CCII\\JUEGO-CC2\\Images\\MarioDeath.png");
		}
		else
		{
			texture.loadFromFile("C:\\Visual studio\\CCII\\JUEGO-CC2\\Images\\BigMarioDeath.png");
		}
	}
		...
		if (0 == dead)
		{
			if (0 < powerup_state)
			{
				if (1 == crouching)
				{
					...
					{
						texture.loadFromFile("C:\\Visual studio\\CCII\\JUEGO-CC2\\Images\\BigMarioCrouch.png");
					}
				}
				else if (0 == on_ground)
				{
					if (0 == draw_big)
					{
						...
						texture.loadFromFile("C:\\Visual studio\\CCII\\JUEGO-CC2\\Images\\MarioJump.png");
					}
					else
					{
						texture.loadFromFile("C:\\Visual studio\\CCII\\JUEGO-CC2\\Images\\BigMarioJump.png");
					}
				}
				else
				{
					if (0 == horizontal_speed)
					{
						...
						{
							texture.loadFromFile("C:\\Visual studio\\CCII\\JUEGO-CC2\\Images\\BigMarioIdle.png");
						}
					}
...

					{
						if (0 == draw_big)
						{
							...
							texture.loadFromFile("C:\\Visual studio\\CCII\\JUEGO-CC2\\Images\\MarioBrake.png");
						}
						else
						{
							texture.loadFromFile("C:\\Visual studio\\CCII\\JUEGO-CC2\\Images\\BigMarioBrake.png");
						}
					}
					else
					{
